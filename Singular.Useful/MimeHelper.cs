...
namespace Singular.Useful
{
    ...
    {
        // https://github.com/samuelneff/MimeTypeMap/blob/master/src/MimeTypeMap.cs
        ...
        public static string GetMimeFromDotlessExtension(string ext)
        {
            if (_mappings.ContainsKey("." + ext))
            {
